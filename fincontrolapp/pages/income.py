...
class IncomePage(BasePage):
            ...
            ft.Container(
                ...
                content=ft.Row(
                    controls=[
                        ...
                        ft.Text(f"Итого: {month_total:,.0f} {sym}", font_family="Montserrat SemiBold", size=12, color="#483EB7"),
                    ],
            ...
            ft.Row(
                ...
                controls=[
                    ft.Text("Дополнительные доходы", size=16,
                            ...
                            color=ft.Colors.with_opacity(0.6, "#000000")),
                    ft.Text(f"{additional_total:,.0f} {sym}", size=13,
                            font_family="Montserrat SemiBold",
    ...
    def _salary_card(self, salary):
        sym = get_currency_symbol(self.page_ref)
        amount_text = f"{salary['amount']:,.0f} {sym}" if salary else "Не указана"
        return ft.Container(
            padding=16,
            border_radius=16,
            ...
            content=ft.Column([
                ft.Row([
                    ft.Text("Зарплата", size=14, font_family="Montserrat SemiBold",
                            color=ft.Colors.with_opacity(0.6, "#000000")),
                    ft.Container(
                        padding=ft.Padding.only(left=8, right=8, top=3, bottom=3),
                        border_radius=10,
                        bgcolor=ft.Colors.with_opacity(0.15, "#483EB7"),
                        content=ft.Text(
                            "каждый месяц",
                            size=10,
                            font_family="Montserrat SemiBold",
                ...
                ft.Container(
                    ...
                    content=ft.Row(
                        ...
                        spacing=8,
                        controls=[
                            ft.Icon(ft.Icons.EDIT, size=16, color="#000000"),
                            ft.Text(
            ...
            content=ft.Column(
                ...
                controls=[
                    ft.Row(
                        alignment=ft.MainAxisAlignment.SPACE_BETWEEN,
                        controls=[
                            ft.Text("Указать зарплату", color="#000000",
            ...
            content=ft.Column(
                ...
                controls=[
                    ft.Row(
                        alignment=ft.MainAxisAlignment.SPACE_BETWEEN,
                        controls=[
                            ft.Text("Добавить доход", color="#000000",
                                    font_family="Montserrat SemiBold", size=24),
                        ],
                    ),
                    category_dd,
            ...
            content=ft.Column(
                ...
                controls=[
                    ft.Row(
                        alignment=ft.MainAxisAlignment.SPACE_BETWEEN,
                        controls=[
                            ft.Text("Редактировать доход", color="#000000",
                                    font_family="Montserrat SemiBold", size=24),
                        ],
                    ),
                    category_dd,
